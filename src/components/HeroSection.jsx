  ...
  return (
    ...
    >
      ...
      <div className=" ml-10 mr-7 mt-6 sm:mt-0 sm:ml-8">
        ...
        <p className="font-bold text-4xl lg:text-7xl sm:mb-6">Alison Estephany </p>
        <div className="my-3 flex text-2xl sm:text-3xl lg:text-4xl">
          A
          <p className="text-fuchsia-600 dark:text-pink-200 px-1 sm:px-1 lg:px-2 font-bold">
            Fullstack Developer
          </p>
          and
